...
interface DatabaseContextType {
  ...
  getProfilesByRole: (role: UserRole) => Profile[];
  ...
  getUserConversations: (userId: string) => (Conversation & { otherUser: Profile })[];
...
export const DatabaseProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const getProfilesByRole = (role: UserRole) => {
  ...
  const getMessagesBetweenUsers = (userId1: string, userId2: string) => {
